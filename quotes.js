...
function toggleLanguage(){
    ...
    function initialize() {
       ...
       //content.innerHTML = '<div id="text">Hola, me alegro mucho de verte.<\/div><div id="translation"/>';
        var text = document.getElementById("quotes").innerHTML;
        google.language.translate(text, 'sr', 'en', function(result) {
...
function download(){
    ...
    axios({
        url:'file:///C:/Users/dk/Desktop/RandomQuotes/generate.html',
        method:'GET',
        responseType: 'blob'
})
.then((response) => {
       ...
       .createObjectURL(new Blob([response.data]));
              ...
              link.href = url;
              link.setAttribute('download', 'Quete image.jpg');
